...
namespace HoangHiep.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult EditProduct(SanPham newProduct, HttpPostedFileBase[] fUpload)
        {
            ...
            productEdit.NgayCapNhat = newProduct.NgayCapNhat;
        ...
        public ActionResult DeleteOrder(int id)
        {
            ...
            return RedirectToAction("ListOfOrder", "Admin");
        }
        ...
        public ActionResult AddMember(ThanhVien newMember) {
            GetData();
            ViewBag.MaLoaiTV = new SelectList(db.LoaiThanhViens.OrderBy(n => n.TenLoaiTV), "MaLoaiTV", "TenLoaiTV");
            newMember.Avatar = "anonymousUser.png";
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult SendMail(string messageSharecode)
        {
            GetData();
            var toEmailAddress = ConfigurationManager.AppSettings["ToEmailAddress"].ToString();
            var toEmailAddress2 = "hai34739@gmail.com";
            new MailHelper().SendEmail(toEmailAddress, "[Sharecode.vn] - Bạn vừa có thêm 14xu cộng vào tài khoản", messageSharecode);
            new MailHelper().SendEmail(toEmailAddress2, "[Sharecode.vn] - Bạn vừa có thêm 14xu cộng vào tài khoản", messageSharecode);
            return View();
        }
