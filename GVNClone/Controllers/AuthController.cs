...
using System.IO;
using Common;
using HoangHiep.Models.StatusOrderViewModel;
...
namespace HoangHiep.Controllers
{
    public class AuthController : Controller
    {
        ...
        public ActionResult SignIn(FormCollection f)
        {
            ...
            ThanhVien tv = db.ThanhViens.SingleOrDefault(member => member.Email.Equals(sUserName) && member.MatKhau.Equals(sPassword));
            if (tv != null)
            {
                Session["Account"] = tv;
